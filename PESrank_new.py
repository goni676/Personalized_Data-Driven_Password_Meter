    ...
    if isascii(password):
        ...
        if f == len(password):
            ...
            if maxProb > 0:
                ...
                if indicator and pp4 is not None:
                    pp4 = float(pp4) * distribution['a4']
                pp5 = BS.main4(a5_path, pos2)
                if indicator and pp5 is not None:
